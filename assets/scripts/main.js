...
const SEARCH_LYRICS_API = "https://genius-song-lyrics1.p.rapidapi.com";
const LYRICS_API_KEY = "0543352a74msh5ae90a6f46da460p13db80jsn93f2a24a1058";
const SEARCH_LYRICS_API_HOST = "genius-song-lyrics1.p.rapidapi.com";
...
const options = {
  ...
  headers: {
    ...
    "X-RapidAPI-Host": `${SEARCH_LYRICS_API_HOST}`,
  },
};
